...
function show_help() {
  ...
  printf "\n"
  printf "e.g\n"
  printf "    ./virsh_attach_device.sh -d ubuntu --usb mouse\n"
  printf "    ./virsh_attach_device.sh -d ubuntu --usb keyboard\n"
  printf "    ./virsh_attach_device.sh -d ubuntu --usb bluetooth\n"
  printf "    ./virsh_attach_device.sh -d ubuntu --pci wi-fi\n"
  printf "    ./virsh_attach_device.sh -d ubuntu_rt1 --pci i225 1\n"
  printf "    ./virsh_attach_device.sh -d ubuntu_rt2 --pci i225 2\n" 
}
